...
For EACH subscription (`com.lovelinkcouples.premium.monthly` and `com.lovelinkcouples.premium.yearly`):

- [ ] Click the subscription group you just created
- [ ] Click "+" to add a subscription
- [ ] Enter Product ID: `com.lovelinkcouples.premium.monthly` (for monthly)
...
- [ ] Repeat for yearly subscription:
  - Product ID: `com.lovelinkcouples.premium.yearly`
