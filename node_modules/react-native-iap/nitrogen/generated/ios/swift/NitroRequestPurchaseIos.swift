...
public extension NitroRequestPurchaseIos {
  ...
  var andDangerouslyFinishTransactionAutomatically: Bool? {
    ...
    get {
      return { () -> Bool? in
        if bridge.has_value_std__optional_bool_(self.__andDangerouslyFinishTransactionAutomatically) {
          let __unwrapped = bridge.get_std__optional_bool_(self.__andDangerouslyFinishTransactionAutomatically)
          return __unwrapped
        } else {
          return nil
        }
