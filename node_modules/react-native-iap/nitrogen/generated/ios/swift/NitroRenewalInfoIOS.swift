...
public extension NitroRenewalInfoIOS {
   ...
   */
  init(willAutoRenew: Bool, autoRenewPreference: String?, pendingUpgradeProductId: String?, renewalDate: Double?, expirationReason: String?, isInBillingRetry: Bool?, gracePeriodExpirationDate: Double?, priceIncreaseStatus: String?, renewalOfferType: String?, renewalOfferId: String?, jsonRepresentation: String?) {
    self.init(willAutoRenew, { () -> bridge.std__optional_std__string_ in
