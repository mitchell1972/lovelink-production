...
public extension NitroPurchase {
  ...
  var isUpgradedIOS: Bool? {
    ...
    get {
      return { () -> Bool? in
        if bridge.has_value_std__optional_bool_(self.__isUpgradedIOS) {
          let __unwrapped = bridge.get_std__optional_bool_(self.__isUpgradedIOS)
          return __unwrapped
        } else {
          return nil
        }
  ...
  var isAcknowledgedAndroid: Bool? {
    ...
    get {
      return { () -> Bool? in
        if bridge.has_value_std__optional_bool_(self.__isAcknowledgedAndroid) {
          let __unwrapped = bridge.get_std__optional_bool_(self.__isAcknowledgedAndroid)
          return __unwrapped
        } else {
          return nil
        }
