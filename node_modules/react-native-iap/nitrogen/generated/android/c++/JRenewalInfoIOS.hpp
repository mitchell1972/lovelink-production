...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    static jni::local_ref<JRenewalInfoIOS::javaobject> fromCpp(const RenewalInfoIOS& value) {
      using JSignature = JRenewalInfoIOS(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jboolean);
      static const auto clazz = javaClassStatic();
