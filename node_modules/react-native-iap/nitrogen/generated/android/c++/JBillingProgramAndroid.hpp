...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    static jni::alias_ref<JBillingProgramAndroid> fromCpp(BillingProgramAndroid value) {
      ...
      static const auto fieldEXTERNAL_PAYMENTS = clazz->getStaticField<JBillingProgramAndroid>("EXTERNAL_PAYMENTS");
      ...
      switch (value) {
        ...
        case BillingProgramAndroid::EXTERNAL_PAYMENTS:
          return clazz->getStaticFieldValue(fieldEXTERNAL_PAYMENTS);
        default:
