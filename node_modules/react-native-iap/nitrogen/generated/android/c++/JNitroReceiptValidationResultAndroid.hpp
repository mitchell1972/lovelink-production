...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    static jni::local_ref<JNitroReceiptValidationResultAndroid::javaobject> fromCpp(const NitroReceiptValidationResultAndroid& value) {
      using JSignature = JNitroReceiptValidationResultAndroid(jboolean, jboolean, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JString>, double, double, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, double, double, jni::alias_ref<jni::JString>, double, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jboolean);
      static const auto clazz = javaClassStatic();
