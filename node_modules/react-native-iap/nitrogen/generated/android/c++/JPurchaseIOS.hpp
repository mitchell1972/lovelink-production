...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    PurchaseIOS toCpp() const {
      ...
      static const auto fieldRenewalInfoIOS = clazz->getField<JRenewalInfoIOS>("renewalInfoIOS");
      jni::local_ref<JRenewalInfoIOS> renewalInfoIOS = this->getFieldValue(fieldRenewalInfoIOS);
